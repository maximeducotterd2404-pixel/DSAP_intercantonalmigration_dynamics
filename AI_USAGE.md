...
- Guidance on time-based splits, how to use `migration_lag1`, avoiding leakage, and aligning with the course rulebook requirements.
...
## My contributions
- The code was co‑written with AI assistance and then tailored to meet the course structure and requirements.
