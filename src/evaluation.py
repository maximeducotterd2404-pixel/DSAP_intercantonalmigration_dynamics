...
def plot_randomforest_true_vs_pred(y_true, y_pred, title="Random Forest – True vs Predicted"):
...
def plot_gradientboosting_true_vs_pred(y_true, y_pred, title="Boosting – True vs Predicted"):
